...
export default function MegaMenu({ open, onClose, triggerRef }) {
  ...
  return (
    <div
      ...
      ref={panelRef}
      className="absolute top-full left-1/2 -translate-x-1/2 mt-3 w-[min(90vw,880px)]
          ...
          return (
            <Link
              ...
              className="flex items-start gap-3 rounded-xl p-3 transition-colors
                hover:bg-gray-50 focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-gold-600"
            >
